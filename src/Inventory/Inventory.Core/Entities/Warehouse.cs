...
public class Warehouse : Entity<Guid>
{
    ...
    private Warehouse() {}
    public Warehouse(string name, string description, int tenantId, string code, string address, int branchId)
    {
        Id = Guid.NewGuid();
        Name = name;
    ...
    public static Warehouse CreateNewStore(string name, string description, string code, string address, int teneatId, int branchId = 1)
    {
        return new Warehouse(name, description, teneatId, code, address, branchId);
    }
